class popular extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.innerHTML = `<div class="popularCard">
                    <img src="${this.imagen}" class="popularImagen"></img>
                    <h3 class="destinoPopular">${this.destino}</h3>
                    <p class="desc">${this.desc}</p><br>
                    <p class="desc">desde</p>
                    <h3 class="precioPopular">${this.precio}</h3>
                </div>`;
  }
}

window.customElements.define("popular-new", popular);
